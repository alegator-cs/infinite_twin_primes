...
cofinal tail contradicts a finite-base MP/PM certificate plus successor-recovery certificate.  The
...
generated C++ certificate emits the arithmetic route chains.  The full
...
successor field is the DFI--Toth-shaped recovery step.  Given such a
certificate, Lean derives
\[
...
Given a value of \(\Lean{GeneratedSuccessorRecoveryCertificate}\),
\[
  \forall N,\ \exists p,\ N\le p\wedge\Prime(p)\wedge\Prime(p+2).
\]
\end{theorem}
