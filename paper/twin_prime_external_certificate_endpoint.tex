...
\begin{filelist}
  ...
  \FileEntry{TwinPrimeExternal/RoutedMPPMChainBridge.lean}
  \begin{itemize}[leftmargin=1.5em,itemsep=0.15em]
  ...
  \FileEntry{TwinPrimeExternal/GeneratedTailInductionCertificate.lean}
  \begin{itemize}[leftmargin=1.5em,itemsep=0.15em]
...
\[
  \Lean{GeneratedTailInductionCertificate.no\_cofinalExceptionTail\_of\_routedChainRealization}.
\]
The only project-specific external certificate needed to derive it is
\[
  \Lean{RoutedChainRealizationCertificate}.
\]
...
\begin{filelist}
  ...
  \FileEntry{TwinPrimeExternal/RoutedMPPMChainCertificate.lean}
  \begin{itemize}[leftmargin=1.5em,itemsep=0.15em]
  ...
  \FileEntry{TwinPrimeExternal/GeneratedRoutedMPPMChains/Index.lean}
  \begin{itemize}[leftmargin=1.5em,itemsep=0.15em]
...
\begin{itemize}
  \item \Code{TwinPrimeExternal.lean}: the aggregate import file for the Lean library.
  ...
  \item \Code{TwinPrimeExternal/RoutedMPPMChainCertificate.lean}: defines the
  ...
  \item \Code{TwinPrimeExternal/GeneratedRoutedMPPMChains/ShardNNN.lean}: the
  ...
  \item \Code{TwinPrimeExternal/GeneratedRoutedMPPMChains/Index.lean}: imports
  all shards and proves the global generated counts, including
  \(\Lean{GeneratedRoutedMPPMChains.checkedChainCount}=95569\).

  \item \Code{TwinPrimeExternal/RoutedMPPMChainBridge.lean}: converts the checked
  ...
  \item \Code{TwinPrimeExternal/TailInductionCertificate.lean}: packages the
  ...
  \item \Code{TwinPrimeExternal/GeneratedTailInductionCertificate.lean}: connects
...
\begin{itemize}
  \item \Code{paper/twin\_prime\_external\_certificate\_endpoint.tex}: this paper.
  ...
  \item \Code{lakefile.toml}: Lean package definition for \Code{TwinPrimeExternal}.
